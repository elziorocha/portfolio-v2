...
const Apresentação = () => {
    return (
        <div className="flex flex-col gap-14 px-24 font-Nunito text-orange-600">
            <div className="text-center text-4xl font-bold text-shadow-md">
                <Typewriter />
            </div>

            <hr className="w-2/3 self-center rounded-full border-2 border-black"/>

            <div className="mb-6 flex flex-col gap-8">
                <div className="flex flex-row items-start gap-x-4">
                    <CornerDownRight size={35}/>
                    <h1 className="w-2/3 items-start text-2xl font-semibold text-shadow">
                        Atualmente cursando o 5º Período Engenharia de Software na Instituição Faculdade Campo Real
                    </h1>
                </div>
                <div className="flex flex-row items-start gap-x-4">
                    <CornerDownRight size={35} />
            ...
            <div className="flex flex-col gap-8 text-right">
                <div className="ml-auto flex flex-row items-start gap-x-4">
                    <h1 className="ml-auto w-2/3 items-start text-2xl font-semibold text-shadow">
                        Pondo em prática tecnologias e conhecimentos obtidos em aulas e projetos pessoais
                    </h1>
