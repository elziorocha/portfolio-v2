...
const Inicio = () => {
    return (
        <>
            ...
            dark:text-violet-800 md:p-16 lg:flex-row lg:p-12 xl:w-8/12">
                ...
                <img src={'/images/foto1.JPEG'} alt="foto" className="custom-border-radius size-64 border-4 border-orange-600 object-cover 
