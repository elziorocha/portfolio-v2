...
const Inicio = () => {
    return (
        <div className="mt-24 flex w-9/12 flex-row items-center justify-center gap-12 self-center rounded-2xl
        p-12 font-Nunito text-orange-600 shadow-[inset_0_4px_20px_7px_rgb(0,0,0)]">
