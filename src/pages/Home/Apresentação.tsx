            ...
            text-shadow dark:font-bold dark:text-violet-800 dark:text-shadow-none xl:px-24">
                ...
                <div className="mb-6 flex flex-col gap-8 text-left">
                    <div className="flex flex-row items-start gap-x-4">
                        ...
                        <h1 className="w-2/3 items-start">
                            Atualmente cursando o 6º Período Engenharia de Software na Instituição Faculdade Campo Real
                        </h1>
                    </div>
                    <hr className="w-8/12 rounded-full border border-orange-700 dark:border-black md:w-4/12" />
                    <div className="flex flex-row items-start gap-x-4">
                        <CornerDownRight size={35} className="hidden md:block"/>
                        <h1 className="w-2/3 items-start">
                ...
                <div className="flex flex-col gap-8 text-right">
                    <div className="flex flex-row items-start gap-x-4">
                        <h1 className="ml-auto w-2/3 items-start">
                    ...
                    <hr className="ml-auto w-8/12 rounded-full border border-orange-700 dark:border-black md:w-4/12" />
                    <div className="flex flex-row items-start gap-x-4">
                        <h1 className="ml-auto w-2/3 items-start">
